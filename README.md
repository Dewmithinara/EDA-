...
This repository contains three Jupyter Notebook files focused on **Exploratory Data Analysis (EDA)** and basic **feature understanding/engineering** on different real-world datasets. Each notebook demonstrates how to clean data, analyze patterns, and extract useful insights using Python data analysis libraries.
...
* Analysis of airlines, source, destination, and stops
...
* Distribution analysis of chemical properties
